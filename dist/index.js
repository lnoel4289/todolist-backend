...
app.get("/login", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var userRequest, db, usersCollection, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return client.connect();
        case 4:
          db = client.db("mytodolist");
          usersCollection = db.collection("users");
          _context.next = 8;
          return usersCollection.findOne(userRequest);
        case 8:
          user = _context.sent;
          if (!user) {
            res.status(401).send("Les informations fournie ne permettent pas de vous identifier");
          } else {
            res.status(200).send("Bienvenue ".concat(user.pseudo, " ! Vous \xEAtes maintenant connect\xE9."));
          }
          _context.next = 16;
          break;
        case 12:
